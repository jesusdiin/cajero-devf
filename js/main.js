...
const botonesPublic = `
    ...
    <div class="col-sm-12 bg-white shadow-lg pantallaAtm">
        <div class="d-grid gap-2 col-10 mx-auto">
            ...
            <a href="#" class="btn btn-danger" data-bs-dismiss="modal">Salir</a>
        </div>
    </div>
`
...
for (let index = 0; index < users.length; index++) {
    var cardSelect = () => {
        alert(`Card de ${users[index].name}`)
    }
    var card = `
        <div class="card" id="card${index}" aria-hidden="true" onclick="cardSelect()">
            <div class="card-body">
